      ...
      <AboutMeWrapper data-aos="fade-right">
        <div className="aboutSection">
          <div className="left">
            ...
            <p></p>
            <p>
              Email: <span>balisrinu1996@gmail.com</span>
            </p>
            <p>
          ...
          <div className="right">
            ...
            <p id="user-detail-intro">
              Hello Techie! 👋, my name is Srinu Bali
              and I am a Frontend Web Developer, passionate
              about building a website that improves the everyday
              experience for people.  </p>
            I am a Quick learner and an aspiring Full Stack Web Developer with core knowledge of MERN Stack. Looking forward to applying and enhancing my skills and knowledge as a developer.
